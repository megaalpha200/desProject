...
INITIAL_P_BOX =  [  58, 50, 42, 34, 26, 18, 10, 2,...
...
global FINAL_P_BOX;
FINAL_P_BOX = [ 40, 8, 48, 16, 56, 24, 64, 32,...
...
global PARITY_BIT_DROP_P_BOX;
PARITY_BIT_DROP_P_BOX = [   57, 49, 41, 33, 25, 17, 9, 1,...
...
global KEY_COMPRESSION_P_BOX;
KEY_COMPRESSION_P_BOX = [   14, 17, 11, 24, 1, 5, 3, 28,...
...
global S_BOX_GROUP;
global SHIFT_ONCE_ROUNDS;

S_BOX_GROUP = cat(3,S_BOX_1, S_BOX_2, S_BOX_3, S_BOX_4, S_BOX_5, S_BOX_6, S_BOX_7, S_BOX_8);
SHIFT_ONCE_ROUNDS = [1, 2, 9, 16];
